...
import static com.lamfire.jmongo.AnnotationBuilder.toMap;
import static com.lamfire.jmongo.utils.IndexType.fromValue;
...
final class IndexHelper {
    ...
    void createIndex(final MongoCollection collection, final MappedClass mc, final Index index, final boolean background) {
        ...
        if(LOG.isDebugEnabled()) {
            LOG.debug("createdIndex : " + collection.getNamespace().getFullName() + " -> " + keys);
        }
    }
}
